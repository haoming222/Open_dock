...
def get_params():
    params = {
        'weight': 'D:/study/yolov5_study/yolov5-7.0/yolov5/runs/train/exp20_200ep_quad_2classes_improve/weights/best.pt',
        'device': 'cuda:0',
        'method': 'XGradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [17, 20, 23],
        'backward_type': 'all', # class, box, allGradCAM_Class
...
if __name__ == '__main__':
    ...
    model(r'D:/study/yolov5_study/yolov5-7.0/yolov5/data/images', 'heatmap_result/or')