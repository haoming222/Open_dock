...
import cv2
# 数据集类别名
names = ['FD_port','XP_port','LZ_port']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_18_cv3_act', 'model_21_cv3_act', 'model_24_cv3_act']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="D:/study/yolov5_study/yolov5-7.0/yolov5/runs/train/GAMAttentionBeforeSPPF_200epo_quad/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='data/images/19.jpg', help='input image path')
parser.add_argument('--output-dir', type=str, default='runs/result17', help='output dir')
parser.add_argument('--img-size', type=int, default=640, help="input image size")
parser.add_argument('--target-layer', type=str, default='model_21_cv3_act',
