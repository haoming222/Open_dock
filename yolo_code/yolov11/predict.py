...
# 读取模型，这里传入训练好的模型
model = YOLO('./runs/detect/grid500dataset_yolov11_1280size_200epo/weights/best.pt')
...
metrics = model.predict(source="G:/data/500/all_model/train_1280size/yolov11/buffer_500/6/test_dataset/img",
                        save=True,save_txt=True,save_conf=True,imgsz=2880)
save_dir = "G:/data/500/all_model/train_1280size/yolov11/buffer_500/6/detect_result_h_w"
